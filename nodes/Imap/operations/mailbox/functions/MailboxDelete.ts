...
export const deleteMailboxOperation: IResourceOperationDef = {
  ...
  parameters: [
    ...
    },
    {
      ...
      type: 'boolean',
      default: "={{ $fromAI('confirm_delete', 'Confirmation that the mailbox should be permanently deleted (true to delete)') }}",
      description: 'Final confirmation required to delete the mailbox. AI must explicitly confirm deletion.',
      required: true,
    },
  ],
